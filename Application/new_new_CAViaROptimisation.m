function [BetaHat, output] = new_new_CAViaROptimisation(Y, MODEL, THETA)
...
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/dataCAViaR.txt 
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/lr.txt 
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/lr2.txt 
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/CAC40.txt 
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/DAX.txt 
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/FTSE.txt
% load /Users/ann/Downloads/research/Project_implied_conditional_moments/CAViaRCodes_matlab/主要程序/Nikkei.txt
% *****************************************************************************************
...
%inSampleObs = round(0.75*totalObs);	
inSampleObs = totalObs;
...
elseif MODEL == 4 % See the comment in RQobjectivefunction.m lines 66-70 for this model.
    nInitialVectors = [100000, 1]; % Number of initial vector fed in the uniform random number generator for AS model.
    nInitialCond = 5;            % Select the number of initial conditions for the optimisation.
end
MaxFunEvals = 20*totalObs; % Parameters for the optimisation algorithm. Increase them in case the algorithm does not converge.
MaxIter     = 20*totalObs;
...
rng(50)                  % Set the random number generator seed for reproducability (seed used in the paper = 50).
...
for t = 1:nSamples
   ysort(:, t)          = sortrows(y(1:round(0.1*inSampleObs), t), 1); 
   empiricalQuantile(t) = ysort(ceil(round(0.1*inSampleObs)*THETA), t);
end
...
%************************** Compute variables that enter output *****************************
    ...
    DQinSample(1,t)    = DQtest(1, inSampleObs, y(:,t), THETA, VaR(1:inSampleObs,t), Hit(1:inSampleObs,t), D, gradient);
    %DQoutOfSample(1,t) = DQtest(2, totalObs - inSampleObs, ytot((inSampleObs + 1):totalObs, t), THETA, VaR((inSampleObs + 1):totalObs, t), Hit((inSampleObs + 1):totalObs, t), D, gradient);
