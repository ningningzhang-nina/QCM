...
step 1: run description0.m to get Tables 1; 
step 2: run 2TAR.m and save results in new_new_AUD_USD_cvm_test.mat, new_new_NZD_USD_cvm_test.mat, and new_new_CAD_USD_cvm_test.mat, and Table 2;
...
step 5: run test_moment_by_studentt_test4.m and test_garchsk_results to get Table 3;
step 6: run plot_moment6.R to get Figure 1
step 7: run generate_cv_bandwidth.R and save results in nic_bandwidth.mat;
step 9: run plot_nic_and_bandwidth5.R to get Figure 2 and Table 5;
