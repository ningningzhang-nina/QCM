function [res,DnC,DnC_star,DnI,DnI_star,pvalues] = CvM_test_tar_AUD_USD(y,nboot)
X0=ones(length(y),1);
    ...
    mdl=fitlm([XX3,XX4,XX5],y,'Intercept',false);

x0=mdl.Coefficients.Estimate;
[x0,mdl.Coefficients.pValue]
res=y'-[XX3,XX4,XX5]*x0;
tic;
...
for i=1:nboot
    tic;
    res_star = WB(:,i)';
    f_hat=[XX3,XX4,XX5]*x0;
    y_star = f_hat'+res_star;
    mdl1=fitlm([XX3,XX4,XX5],y_star,'Intercept',false);
    phat=mdl1.Coefficients.Estimate;
    [phat,mdl1.Coefficients.pValue]
    res_star_star=y_star'-[XX3,XX4,XX5]*phat;
