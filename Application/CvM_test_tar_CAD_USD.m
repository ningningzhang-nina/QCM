function [res,DnC,DnC_star,DnI,DnI_star,pvalues] = CvM_test_tar_CAD_USD(y,nboot)
    X0=ones(length(y),1);
...
for i=1:nboot
    tic;
    res_star = WB(:,i)';
    f_hat=[XX4,XX5,XXX3,XXX6]*x0;
    y_star = f_hat'+res_star;
    mdl1=fitlm([XX4,XX5,XXX3,XXX6],y_star,'Intercept',false);
    phat=mdl1.Coefficients.Estimate;
    [phat,mdl1.Coefficients.pValue]
    res_star_star=y_star'-[XX4,XX5,XXX3,XXX6]*phat;
