function output = DQtest(OUT, T, y, THETA, VaR, Hit, D, gradient)
...
elseif OUT == 2
    ...
    error('Wrong output selected. Choose OUT = 1 for in sample DQ test, or OUT = 2 for out of sample DQ test.')
end