...
####正在跑
xdata<-readMat("no_variance_new_DGP1_garch.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="no_variance_new_dgp1_case5_muhat.csv")
write.matrix(sigma2hat,file="no_variance_new_dgp1_case5_sigma2hat.csv")
write.matrix(skewhat,file="no_variance_new_dgp1_case5_skewhat.csv")
write.matrix(kurthat,file="no_variance_new_dgp1_case5_kurthat.csv")
#######CASE 2
...
#######CASE 22
#xdata<-readMat("final_simulation_studentt_timevaring_original_noar.mat")
xdata<-readMat("new_new_DGP2_studentt.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="new_new_dgp2_case5_muhat.csv")
write.matrix(sigma2hat,file="new_new_dgp2_case5_sigma2hat.csv")
write.matrix(skewhat,file="new_new_dgp2_case5_skewhat.csv")
write.matrix(kurthat,file="new_new_dgp2_case5_kurthat.csv")
#######CASE 222
#xdata<-readMat("final_simulation_studentt_timevaring_original_noar.mat")
xdata<-readMat("no_variance_new_new_DGP2_studentt.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="no_variance_new_new_dgp2_case5_muhat.csv")
write.matrix(sigma2hat,file="no_variance_new_new_dgp2_case5_sigma2hat.csv")
write.matrix(skewhat,file="no_variance_new_new_dgp2_case5_skewhat.csv")
write.matrix(kurthat,file="no_variance_new_new_dgp2_case5_kurthat.csv")



## chisquare
xdata<-readMat("new_DGP6_chisquare.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="dgp6_case5_muhat.csv")
write.matrix(sigma2hat,file="dgp6_case5_sigma2hat.csv")
write.matrix(skewhat,file="dgp6_case5_skewhat.csv")
write.matrix(kurthat,file="dgp6_case5_kurthat.csv")
#######CASE 3
...
#xdata<-readMat("simulation_garch_snp_caviar.mat")
#####
xdata<-readMat("no_variance_new_DGP3_garch_snp.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="no_variance_new_dgp3_case5_muhat.csv")
write.matrix(sigma2hat,file="no_variance_new_dgp3_case5_sigma2hat.csv")
write.matrix(skewhat,file="no_variance_new_dgp3_case5_skewhat.csv")
write.matrix(kurthat,file="no_variance_new_dgp3_case5_kurthat.csv")
#######CASE 4
...
#######
xdata<-readMat("no_variance_new_DGP4_gir_skew_studentt.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="no_variance_new_dgp4_case5_muhat.csv")
write.matrix(sigma2hat,file="no_variance_new_dgp4_case5_sigma2hat.csv")
write.matrix(skewhat,file="no_variance_new_dgp4_case5_skewhat.csv")
write.matrix(kurthat,file="no_variance_new_dgp4_case5_kurthat.csv")
#######CASE 5
...
#######CASE 5
xdata<-readMat("no_variance_dgp5_arma_mx_garch.mat")
muhat<-matrix(0,100,1000)
sigma2hat<-matrix(0,100,1000)
skewhat<-matrix(0,100,1000)
kurthat<-matrix(0,100,1000)
...
write.matrix(muhat,file="no_variance_dgp5_case5_muhat.csv")
write.matrix(sigma2hat,file="no_variance_dgp5_case5_sigma2hat.csv")
write.matrix(skewhat,file="no_variance_dgp5_case5_skewhat.csv")
write.matrix(kurthat,file="no_variance_dgp5_case5_kurthat.csv")
